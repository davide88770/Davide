/* Ghisa & Grammi — service worker, versione 20338851f2 */
const CACHE = 'ghisa-e-grammi-20338851f2';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: '20338851f2' }); } catch (e) {} }
