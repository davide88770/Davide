/* Ghisa & Grammi — service worker, versione e4a7f17282 */
const CACHE = 'ghisa-e-grammi-e4a7f17282';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: 'e4a7f17282' }); } catch (e) {} }
