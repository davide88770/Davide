/* Ghisa & Grammi — service worker, versione f35aae3f0e */
const CACHE = 'ghisa-e-grammi-f35aae3f0e';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: 'f35aae3f0e' }); } catch (e) {} }
