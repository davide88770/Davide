/* Ghisa & Grammi — service worker, versione 6169012640 */
const CACHE = 'ghisa-e-grammi-6169012640';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: '6169012640' }); } catch (e) {} }
