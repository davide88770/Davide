/* Ghisa & Grammi — service worker, versione dde9a45317 */
const CACHE = 'ghisa-e-grammi-dde9a45317';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: 'dde9a45317' }); } catch (e) {} }
