/* Ghisa & Grammi — service worker, versione 9897d0d6c1 */
const CACHE = 'ghisa-e-grammi-9897d0d6c1';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: '9897d0d6c1' }); } catch (e) {} }
