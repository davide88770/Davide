/* Ghisa & Grammi — service worker, versione 751178f4d7 */
const CACHE = 'ghisa-e-grammi-751178f4d7';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: '751178f4d7' }); } catch (e) {} }
