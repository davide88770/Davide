/* Ghisa & Grammi — service worker, versione d1c6fa6a3a */
const CACHE = 'ghisa-e-grammi-d1c6fa6a3a';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: 'd1c6fa6a3a' }); } catch (e) {} }
