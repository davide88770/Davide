/* Ghisa & Grammi — service worker, versione a27b3e99e3 */
const CACHE = 'ghisa-e-grammi-a27b3e99e3';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: 'a27b3e99e3' }); } catch (e) {} }
