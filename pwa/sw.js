/* Ghisa & Grammi — service worker, versione 1e2796f1e8 */
const CACHE = 'ghisa-e-grammi-1e2796f1e8';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: '1e2796f1e8' }); } catch (e) {} }
