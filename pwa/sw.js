/* Ghisa & Grammi — service worker, versione de0928da39 */
const CACHE = 'ghisa-e-grammi-de0928da39';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: 'de0928da39' }); } catch (e) {} }
