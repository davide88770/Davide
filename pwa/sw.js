/* Ghisa & Grammi — service worker, versione 8cbe49353c */
const CACHE = 'ghisa-e-grammi-8cbe49353c';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: '8cbe49353c' }); } catch (e) {} }
