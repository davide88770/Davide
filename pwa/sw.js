/* Ghisa & Grammi — service worker, versione c36e012927 */
const CACHE = 'ghisa-e-grammi-c36e012927';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: 'c36e012927' }); } catch (e) {} }
