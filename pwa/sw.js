/* Ghisa & Grammi — service worker, versione 57796c4e95 */
const CACHE = 'ghisa-e-grammi-57796c4e95';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: '57796c4e95' }); } catch (e) {} }
