/* Ghisa & Grammi — service worker, versione 133a9bb219 */
const CACHE = 'ghisa-e-grammi-133a9bb219';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: '133a9bb219' }); } catch (e) {} }
