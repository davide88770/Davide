/* Ghisa & Grammi — service worker, versione 5b3a30bd2a */
const CACHE = 'ghisa-e-grammi-5b3a30bd2a';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: '5b3a30bd2a' }); } catch (e) {} }
