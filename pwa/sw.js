/* Ghisa & Grammi — service worker, versione bafb33ab35 */
const CACHE = 'ghisa-e-grammi-bafb33ab35';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: 'bafb33ab35' }); } catch (e) {} }
