/* Ghisa & Grammi — service worker, versione 592240c71a */
const CACHE = 'ghisa-e-grammi-592240c71a';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: '592240c71a' }); } catch (e) {} }
