/* Ghisa & Grammi — service worker, versione 1fdac59fde */
const CACHE = 'ghisa-e-grammi-1fdac59fde';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: '1fdac59fde' }); } catch (e) {} }
