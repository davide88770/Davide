/* Ghisa & Grammi — service worker, versione 58ad588d38 */
const CACHE = 'ghisa-e-grammi-58ad588d38';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: '58ad588d38' }); } catch (e) {} }
