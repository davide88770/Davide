/* Ghisa & Grammi — service worker, versione 4abc4373bf */
const CACHE = 'ghisa-e-grammi-4abc4373bf';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: '4abc4373bf' }); } catch (e) {} }
