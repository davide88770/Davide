/* Ghisa & Grammi — service worker, versione b95e43d302 */
const CACHE = 'ghisa-e-grammi-b95e43d302';
...
self.addEventListener('activate', ev => {
  ev.waitUntil((async () => {
    ...
    for (const c of clienti) { try { c.postMessage({ gg: 'aggiornata', versione: 'b95e43d302' }); } catch (e) {} }
